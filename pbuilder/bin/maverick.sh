...
sudo pbuilder $OPERATION \
	...
	--hookdir "$BASE_DIR/pbuilder/hooks" \
        --mirror "http://kambing.ui.ac.id/ubuntu" --components "main restricted universe multiverse" \
        --othermirror "deb http://kambing.ui.ac.id/ubuntu maverick-updates main restricted universe multiverse|deb http://kambing.ui.ac.id/ubuntu maverick-security main restricted universe multiverse" \
        --debbuildopts -j4 \
        --buildresult $RESULT "$@"
else
